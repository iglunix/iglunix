...
package() {
	...
	ln -s ../../lib/libbz2.so.$pkgver $pkgdir/usr/lib/libbz2.so
	ln -s ../../lib/libbz2.so.$pkgver $pkgdir/usr/lib/libbz2.so.1
	ln -s ../../lib/libbz2.so.$pkgver $pkgdir/usr/lib/libbz2.so.1.0
